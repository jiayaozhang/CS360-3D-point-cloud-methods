...
def kdtree_recursive_build(root, db, point_indices, axis, leaf_size):
    ...
    if len(point_indices) > leaf_size:
        ...
        # 作业1
        # 屏蔽开始
        # get the middle point after ranking
        middle_left_idx = math.ceil(point_indices_sorted.shape[0]/2) - 1
        # get the idx of the middle point after ranking
        middle_left_point_idx = point_indices_sorted[middle_left_idx]
        #get the value of the middle point after ranking
        middle_left_value = db[middle_left_point_idx, axis]

        #get the right point and all above infomation
        middle_right_idx = middle_left_idx  + 1
        middle_left_point_idx = point_indices_sorted[middle_right_idx]
